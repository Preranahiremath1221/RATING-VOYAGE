...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu-sub"
      className={cn(
        "mx-3.5 flex translate-x-px flex-col gap-1 border-l border-sidebar-border px-2.5 py-0.5",
        className
      )}
    {...props}
  />
